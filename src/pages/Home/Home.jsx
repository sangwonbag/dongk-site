  ...
  return (
    <MainLayout>
      <div className="home-page">
        {/* ==========================================
           1. Hero Section (3D Isometric Backdrop)
           ========================================== */}
              ...
              <div className="trust-badges">
                <div className="badge-card" onClick={() => nav("/materials")}>
                  ...
                  <div className="badge-text">
                    ...
                    <span className="badge-desc">LX, KCC 등 유명 브랜드 친환경 정품 자재 최저가 공급</span>
                  </div>
                </div>
                ...
                <div className="badge-card" onClick={() => nav("/estimate/request")}>
                  ...
                  <div className="badge-text">
                    ...
                    <span className="badge-desc">경력 10년 이상의 베테랑 바닥 도배 전문 시공단 직영 운영</span>
                  </div>
                </div>
                ...
                <div className="badge-card" onClick={() => nav("/estimate/request")}>
                  ...
                  <div className="badge-text">
                    ...
                    <span className="badge-desc">수도권 무료 방문 실측 및 현장 여건 반영 투명한 실적 계산</span>
                  </div>
                </div>
              </div>
            </div>
